// const btnRemove= document.getElementById('art1-remove')
// console.log (btnRemove)

// btnRemove.addEventListener ( 'click' , ()=> {
// alert('voulez vous vraiment supprmer')
// })

// document.getElementById('art1-remove').forEach(button => {
...
// Add event listeners for product 1// Add event listeners for product 2
